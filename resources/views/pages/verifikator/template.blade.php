...
new #[Layout('layouts.app')] class extends Component {
    ...
    /**
     * Hanya verifikator dan admin yang boleh mengelola template.
     */
    protected function pastikanBerwenang(): void
    {
        abort_unless(
            auth()->user()->isVerifikator() || auth()->user()->isAdmin(),
            403
        );
    }
