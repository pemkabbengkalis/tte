        ...
        <div class="rounded-xl border border-blue-200 bg-blue-50 p-5 ring-1 ring-blue-100">
            <div class="flex items-start gap-3">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    @endif
                    @can('ajukanPerpanjangan', $permohonan)
                        <div class="mt-3 flex justify-end">
                            <a href="{{ route('pemohon.perpanjang', $permohonan->id) }}" wire:navigate
                                class="inline-flex items-center gap-1.5 rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-blue-700">
                                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
